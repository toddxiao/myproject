package com.mycompany.myproject.functional.rest;
...
import com.mycompany.myproject.data.TaskData;
import com.mycompany.myproject.entity.Task;
import com.mycompany.myproject.functional.BaseFunctionalTestCase;
...
public class TaskRestFT extends BaseFunctionalTestCase {
	...
	private static class TaskList extends ArrayList<Task> {
        ...
        */ 
        private static final long serialVersionUID = -5239084608986842063L;
	};
